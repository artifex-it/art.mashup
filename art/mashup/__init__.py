...
from art.mashup.content.validators import areURLsValidator

from zope.i18nmessageid import MessageFactory
from art.mashup import config
...
mashupMessageFactory = MessageFactory('art.mashup')

validation.register(areURLsValidator())
